...
const financialMarketProductMapper = (attributes: any): FinancialMarketProductMetadata => ({
    fipPositionType: dataMapper(attributes, 'msfsi_financialmarketproducttype'),
});

const positionsMapper = (attributes: any): any => ({
    fiPositionType: dataMapper(attributes, 'msfsi_positiontype'),
});
...
export const fhEntityToMapper = {
    ...
    msfsi_fi_position: positionsMapper,
};
